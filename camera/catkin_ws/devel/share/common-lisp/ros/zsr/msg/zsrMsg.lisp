...
(cl:defmethod cl:initialize-instance :after ((m <zsrMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'zsrMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zsr-msg:<zsrMsg> is deprecated: use zsr-msg:zsrMsg instead.")))

(cl:ensure-generic-function 'utcTime-val :lambda-list '(m))
(cl:defmethod utcTime-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:utcTime-val is deprecated.  Use zsr-msg:utcTime instead.")
  (utcTime m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:latitude-val is deprecated.  Use zsr-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:longitude-val is deprecated.  Use zsr-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:altitude-val is deprecated.  Use zsr-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:heading-val is deprecated.  Use zsr-msg:heading instead.")
  (heading m))

(cl:ensure-generic-function 'propertyType-val :lambda-list '(m))
(cl:defmethod propertyType-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:propertyType-val is deprecated.  Use zsr-msg:propertyType instead.")
  (propertyType m))

(cl:ensure-generic-function 'measure-val :lambda-list '(m))
(cl:defmethod measure-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:measure-val is deprecated.  Use zsr-msg:measure instead.")
  (measure m))

(cl:ensure-generic-function 'feature-val :lambda-list '(m))
(cl:defmethod feature-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:feature-val is deprecated.  Use zsr-msg:feature instead.")
  (feature m))

(cl:ensure-generic-function 'process-val :lambda-list '(m))
(cl:defmethod process-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:process-val is deprecated.  Use zsr-msg:process instead.")
  (process m))

(cl:ensure-generic-function 'parameter-val :lambda-list '(m))
(cl:defmethod parameter-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:parameter-val is deprecated.  Use zsr-msg:parameter instead.")
  (parameter m))

(cl:ensure-generic-function 'resultQuality-val :lambda-list '(m))
(cl:defmethod resultQuality-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:resultQuality-val is deprecated.  Use zsr-msg:resultQuality instead.")
  (resultQuality m))

(cl:ensure-generic-function 'OrchardID-val :lambda-list '(m))
(cl:defmethod OrchardID-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:OrchardID-val is deprecated.  Use zsr-msg:OrchardID instead.")
  (OrchardID m))

(cl:ensure-generic-function 'CameraID-val :lambda-list '(m))
(cl:defmethod CameraID-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:CameraID-val is deprecated.  Use zsr-msg:CameraID instead.")
  (CameraID m))

(cl:ensure-generic-function 'SecondaryCameraID-val :lambda-list '(m))
(cl:defmethod SecondaryCameraID-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:SecondaryCameraID-val is deprecated.  Use zsr-msg:SecondaryCameraID instead.")
  (SecondaryCameraID m))

(cl:ensure-generic-function 'ImageID-val :lambda-list '(m))
(cl:defmethod ImageID-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:ImageID-val is deprecated.  Use zsr-msg:ImageID instead.")
  (ImageID m))

(cl:ensure-generic-function 'SecondaryImageID-val :lambda-list '(m))
(cl:defmethod SecondaryImageID-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:SecondaryImageID-val is deprecated.  Use zsr-msg:SecondaryImageID instead.")
  (SecondaryImageID m))

(cl:ensure-generic-function 'INSlatitude-val :lambda-list '(m))
(cl:defmethod INSlatitude-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:INSlatitude-val is deprecated.  Use zsr-msg:INSlatitude instead.")
  (INSlatitude m))

(cl:ensure-generic-function 'INSlongitude-val :lambda-list '(m))
(cl:defmethod INSlongitude-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:INSlongitude-val is deprecated.  Use zsr-msg:INSlongitude instead.")
  (INSlongitude m))

(cl:ensure-generic-function 'INSaltitude-val :lambda-list '(m))
(cl:defmethod INSaltitude-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:INSaltitude-val is deprecated.  Use zsr-msg:INSaltitude instead.")
  (INSaltitude m))

(cl:ensure-generic-function 'INStime-val :lambda-list '(m))
(cl:defmethod INStime-val ((m <zsrMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zsr-msg:INStime-val is deprecated.  Use zsr-msg:INStime instead.")
  (INStime m))
