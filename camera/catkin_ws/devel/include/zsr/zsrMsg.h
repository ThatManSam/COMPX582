// Generated by gencpp from file zsr/zsrMsg.msg
// DO NOT EDIT!


#ifndef ZSR_MESSAGE_ZSRMSG_H
#define ZSR_MESSAGE_ZSRMSG_H
...
struct zsrMsg_
{
  ...
  typedef boost::shared_ptr< ::zsr::zsrMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::zsr::zsrMsg_<ContainerAllocator> const> ConstPtr;

}; // struct zsrMsg_

typedef ::zsr::zsrMsg_<std::allocator<void> > zsrMsg;

typedef boost::shared_ptr< ::zsr::zsrMsg > zsrMsgPtr;
typedef boost::shared_ptr< ::zsr::zsrMsg const> zsrMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::zsr::zsrMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::zsr::zsrMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::zsr::zsrMsg_<ContainerAllocator1> & lhs, const ::zsr::zsrMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::zsr::zsrMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zsr::zsrMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zsr::zsrMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zsr::zsrMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zsr::zsrMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zsr::zsrMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::zsr::zsrMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::zsr::zsrMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8acb67a9b0a2fd36ULL;
  static const uint64_t static_value2 = 0xaee93ed2e2fde2ccULL;
};

template<class ContainerAllocator>
struct DataType< ::zsr::zsrMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "zsr/zsrMsg";
...
template<class ContainerAllocator>
struct Definition< ::zsr::zsrMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::zsr::zsrMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::zsr::zsrMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::zsr::zsrMsg_<ContainerAllocator>& v)
  {
    s << indent << "utcTime: ";
